...
このディレクトリには、ZEN Keyboard用の3Dプリントデータを格納しています。

## ファイル

STLファイルは `stl/` に格納しています。

現在のファイル:

- `zen-battery-cover-v1.0.stl`
- `zen-controller-cover-v1.0.stl`
- `zen-bottom-left-v1.0.stl`
...
このディレクトリ内の3Dモデルファイルには、リポジトリルートのMITライセンスは適用されません。

3Dモデルファイルには、e24個人利用ライセンスが適用されます。詳細は `LICENSE.md` を確認してください。
